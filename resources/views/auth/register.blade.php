<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="panel-body wrapper-lg">
        ...
        <div class="form-group">
            ...
            <x-text-input id="name" class="form-control input-sm" type="text" name="name" :value="old('name')"
        ...
        <div class="form-group">
            ...
            <x-text-input id="password_confirmation" class="form-control input-sm" type="password"
